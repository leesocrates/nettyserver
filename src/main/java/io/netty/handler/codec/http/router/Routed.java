...
public class Routed extends MethodRouted<Object> {
	public Routed(Object target, boolean notFound, HttpRequest request,
	 ...
	 */
	public static Object instanceFromTarget(Object target)
	 ...
	 * @return null if target is null
	 */
	public Object instanceFromTarget() throws InstantiationException,
