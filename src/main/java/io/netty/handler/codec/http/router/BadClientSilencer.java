 ...
 * onUnknownMessage, onBadClient, and onBadServer to log to more suitable
 * places.
 */
@Sharable
public class BadClientSilencer extends SimpleChannelInboundHandler<Object> {
	...
	public void exceptionCaught(ChannelHandlerContext ctx, Throwable e) {
		...
		if (e instanceof java.io.IOException
				...
				|| // Bad WebSocket frame
				e instanceof java.lang.IllegalArgumentException || // Use
																	// https://...
																	// URL to
																	// connect
																	// to HTTP
																	// server
				e instanceof javax.net.ssl.SSLException || // Use http://... URL
															// to connect to
															// HTTPS server
